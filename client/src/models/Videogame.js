export const getAllVideogames = async () => {
    const req = await fetch("http://localhost:3000/videogames", {
      headers: {
  ...
  export const getVideogameById = async (id) => {
    const req = await fetch(`http://localhost:3000/videogames/${id}`, {
      headers: {
        Accept: "application/json",
        "Content-Type": "application/json",
      },
  ...
  export const updateVideogame = async (id, formData) => {
    const req = await fetch(`http://localhost:3000/videogames/${id}`, {
      headers: {
        Accept: "application/json",
        "Content-Type": "application/json",
